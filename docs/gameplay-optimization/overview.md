...
| 嫌疑人多维指标 | 5维隐藏 + 可见性等级 | fear/defiance/empathy_susceptibility/deception_skill/loyalty，按等级解锁可见 |
...
| # | 问题 | 等级 | 修正措施 |
|---|------|------|----------|
| 19 | 嫌疑人维度单一，压力/供词无法体现个体差异 | P0 | 新增恐惧值(fear) + 5维隐藏指标(defiance/empathy_susceptibility/deception_skill/loyalty)，各维度相互影响 |
